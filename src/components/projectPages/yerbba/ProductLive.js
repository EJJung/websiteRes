    ...
    <Grid container direction="row" justify="center" alignItems="center">
      <Grid item xs={10}>
        <Typography variant='body1' gutterBottom>
          The product has launched on March. Fortunately, we got some of customers. We are focusing on marketing and investors pitch. Since our product poses as an credence good and/or claim, marketing would be tricky. We need to establish credibility of our product. 
        </Typography>
      </Grid>
      <Grid item xs={10}>
        <Typography variant='body1' gutterBottom>
